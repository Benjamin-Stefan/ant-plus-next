 ...
 */
export declare function updateState(sensor: SpeedSensor | SpeedScanner, state: SpeedSensorState | SpeedScanState, data: DataView): void;
//# sourceMappingURL=speedUtils.d.ts.map